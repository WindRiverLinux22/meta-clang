...
python() {
    ...
    if not is_devtoolset_installed:
        bb.fatal("compilert-native requires at least verson 5.1 for libstdc++, please install devtoolset-[7+]-gcc-c++, see https://centos.pkgs.org/7/centos-sclo-rh-x86_64/")
}
